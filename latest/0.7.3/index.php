...
for(var i=0; i<getRowsToBuild.length;i++) {
    ...
    if (getTotalElems != 12 && getTotalElems!=9) {
        createTubesUnOpt("Оболочка жилы",getRowsToBuild[i], options.radius, 6.25 - (i * 0.95), options.mod, options.material, 0, 0 + options.fixY, 0 + options.fixZ, options.innerRadBase + (i * options.innerRad), options.length, options.invert, options.skipStep, 2, options.xMod, options.yMod, options.zMod, '','',tubeFillings);
       ...
       if(innerElemsRadius==1.5) {
        ...
        createTubesUnOpt('Оболочка жилы',getRowsToBuild[i], options.radius, 6.25, options.mod, options.material, 0, 0 + options.fixY, 0 + options.fixZ, options.innerRadBase + (i * options.innerRad), options.length, options.invert, options.skipStep, 2, options.xMod, options.yMod, options.zMod, '','',tubeFillings);

...
plasticPBRGrey.bumpTexture = new BABYLON.Texture("../../textures/plastic/scuffed-plastic-normal.jpg");
...
plasticPBRGrey.metallicTexture =  new BABYLON.Texture("../../textures/plastic/scuffed-plastic-ao.jpg");
...
plasticPBRBlue.microSurfaceTexture = new BABYLON.Texture("../../textures/plastic/scuffed-plastic-ao.jpg",scene);
...
plasticPBRGround.bumpTexture = new BABYLON.Texture("../../textures/plastic/scuffed-plastic-normal.jpg");
...
plasticPBRPink.bumpTexture = new BABYLON.Texture("../../textures/plastic/scuffed-plastic-normal.jpg");
...
plasticPBRLightBlue.bumpTexture = new BABYLON.Texture("../../textures/plastic/scuffed-plastic-normal.jpg");
...
// Positions the camera overwriting alpha, beta, radius
  ...
  if (doonce == 62) {
   ...
   secondBody=parseUri('secondBody');
   noAddHelix=parseUri('noAddHelix');

   if(typeof secondBody==='undefined') { secondBody='nb';} else {secondBody=1}
   if(typeof noAddHelix==='undefined') { noAddHelix='na';} else{noAddHelix=1}

...
<head>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            setTimeout(function() {
                document.getElementById('my-loader').remove();
            }, 7000);
        });
    </script>
</head>
            ...
            var delayCreateScene = function() {
                ...
                */
                ...
                if (location.href.indexOf('noBump') == -1) {
                    plasticPBRGrey.microSurfaceTexture = new BABYLON.Texture("../../textures/plastic/scuffed-plastic-ao.jpg", scene);
                ...
                */
                ...
                if (location.href.indexOf('noBump') == -1) {
                    plasticPBRGround.microSurfaceTexture = new BABYLON.Texture("../../textures/plastic/scuffed-plastic-ao.jpg", scene);
                ...
                if (location.href.indexOf('noBump') == -1) {
                    plasticPBRPink.microSurfaceTexture = new BABYLON.Texture("../../textures/plastic/scuffed-plastic-ao.jpg", scene);
                ...
                if (location.href.indexOf('noBump') == -1) {
                    plasticPBRLightBlue.microSurfaceTexture = new BABYLON.Texture("../../textures/plastic/scuffed-plastic-ao.jpg", scene);
                ...
                */
                ...
                var createCableFilling = function(isCentered = 0, cabFillLength = 1.6, mat, diameter = bodyDiameter + 0.1,
                    ...
                    if (typeof mat === 'undefined' || mat == '') {
                        if (totalCableFillings == 0) {
                            mat = plasticPBRGrey;
                        }
                        if (totalCableFillings == 1) {
                            mat = plasticPBRGrey;
                        }
                        if (totalCableFillings == 2) {
                            mat = plasticPBRGrey;
                        }
                        if (totalCableFillings > 2) {
                            mat = plasticPBRGrey;
                    ...
                    if (wrapWith.indexOf('helix') != -1) {
                        wrapWithHelix(newCF, wrapMaterial, cabFillLength);
                        isWrapped = 1;
                    }
                    var cfObj = {
                        'object': newCF,
                ...
                var linearCurve = function(x = 5) {
                    return [new BABYLON.Vector3(0, 0, 0), new BABYLON.Vector3(x, 0, 0)];
                };
                ...
                var modifyLight = function(obj, param, paramVal) {
                    ...
                    if (param == 'diffuse') {
                        obj.diffuse = paramVal;
                    }
                    if (param == 'specular') {
                        obj.specular = paramVal;
                    }
                }
                ...
                */
                ...
                if (location.href.indexOf('doScreen') != -1) {
                    scene.afterRender = function() {
                        ...
                        if (doonce == 62) {
                            ...
                            var secondBody = parseUri('secondBody');
                            var noAddHelix = parseUri('noAddHelix');
                            if (typeof secondBody === 'undefined') {
                                secondBody = 'nb';
                            }
                            if (typeof noAddHelix === 'undefined') {
                                noAddHelix = 'na';
                            }
                ...
                if (innerElemsRadius == 1.5) {
                    buildElemsDiameter = 0.6;
                }
                if (innerElemsRadius == 2.5) {
                    buildElemsDiameter = 1;
                }
                ...
                for (var i = 0; i < getRowsToBuild.length; i++) {
                    ...
                    if (getTotalElems != 12 && getTotalElems != 9) {
                        ...
                        if (innerElemsRadius == 1.5) {
                            options.initLength = 4.45;
                            options.initCutLength = 4.95;
                        }
                        if (innerElemsRadius == 2.5) {
                            options.initLength = 5.55;
                            options.initCutLength = 6.05;
                        }
                        if (getTotalElems == 12 && innerElemsRadius == 1.5) {
                            options.initLength = 4.45;
                            options.initCutLength = 4.95;
                        }
                        if (getTotalElems == 12 && innerElemsRadius == 2.5) {
                            options.initLength = 4.55;
                            options.initCutLength = 5.05;
                        }
                ...
                if (!getUriParam('secondBody', location.href)) {
                    ...
                    if (getTotalElems == 7) {
                        helixDiameter = 0.8;
                        scaleParamFix = 0.9;
                        bodyResultDiameter += 1.8;
                        options.innerRad = 1.1;
                        options.innerRadBase = 1.2;
                        options.skipStep = 1;
                    }
                    if (getTotalElems == 9) {
                        helixDiameter = 0.8;
                        scaleParamFix = 1;
                        bodyResultDiameter += 1.9;
                        options.innerRad = 1.5;
                        options.innerRadBase = 1.3;
                        options.skipStep = 1;
                        options.zMod = 0.9;
                    }
                    if (getTotalElems == 9 && innerElemsRadius == 2.5) {
                        scaleParamFix = 1.8;
                        bodyResultDiameter += 1.15;
                    }
                    if (getTotalElems == 7 && innerElemsRadius == 2.5) {
                        scaleParamFix = 1.2;
                    }
                    ...
                    if (getTotalElems == 19 && innerElemsRadius == 1.5) {
                        bodyResultDiameter += 2;
                    }
                    if (getTotalElems == 7) {
                        bodyResultDiameter += 1;
                    ...
                    if (getTotalElems == 9 && innerElemsRadius == 1.5) {
                        bodyResultDiameter += 2.28;
                        scaleParamFix += 0.1
                    }
                    if (getTotalElems == 9 && innerElemsRadius == 2.5) {
                        bodyResultDiameter += 3;
                        scaleParamFix = 1.63;
                    }
                    if (getTotalElems == 12) {
                        scaleParamFix = 1.1;
                    ...
                    if (getTotalElems == 7 && innerElemsRadius == 1.5) {
                        helixDiameter += 0.34;
                    }
                    if (getTotalElems == 7 && innerElemsRadius == 2.5) {
                        helixDiameter += 0.64;
                ...
                var colorPulser = function(mesh) {
                    ;
                    if (typeof mesh === 'undefined' || mesh == '' || !mesh) {
                        return false;
                    }
